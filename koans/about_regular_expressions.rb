...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # --------------
    # My note: Never or if we insert a suitable expression after of befor it
  end
  ...
  #
  # Why?
  # My note: they will match as many characters as possible
  # ------------------------------------------------------------------
  ...
  # My note: [...] - include ranges, (|) not. And without optimizations [] - faster then (|)
  # ------------------------------------------------------------------
